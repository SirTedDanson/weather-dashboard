...
var displayCurrent = function (city, day, icon, temp, wind, humidity, uv) {
  ...
  var currentUvContainer = $("<div>").addClass("data title is-5 py-3 pl-3 mb-0 columns is-mobile")
  var currentUvTitle = $("<p>").addClass("data title is-5 p-2 mb-0").text("UV Index: ");
